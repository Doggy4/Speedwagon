...
# Commands-help embed
_commands = CustomEmbed(title='**Speedwagon Support**', description='Общие команды', color=colors.yellow, thumbnail_url='https://i.imgur.com/fStCJ0l.png', fields=[EmbedField(name='**/avatar**', value='Аватар пользователя'), EmbedField(name='**/top online**', value='Топ по часам'), EmbedField(name='**/top vote**', value='Топ по голосам'), EmbedField(name='**/monitoring**', value='Мониторинг серверов'), EmbedField(name='**/player**', value='Информация о пользователе'), EmbedField(name='**/clan**', value='Информация о клане')])
